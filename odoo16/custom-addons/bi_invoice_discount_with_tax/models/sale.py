...
class SaleOrder(models.Model):
    ...
    general_discount = fields.Float(string="Discount (%)",store=True,readonly=False,digits="Discount")
    ...
    # def _prepare_invoice(self):
        # invoice_vals = super(SaleOrder, self)._prepare_invoice()  # Ensure the correct parent class name
        # discount_type_inv = "global"
        
        # # Assuming `self.discount_type` is a string that can either be "percent" or "fixed"
        # if self.discount_type == "percent":  # Use string literals or defined constants
            # discount_method = "per"  # Use single '=' for assignment
        # else:
            # discount_method = "fix"  # Use single '=' for assignment
        
        # discount_amount = self.amount_discount
        # invoice_vals.update({
            # 'discount_type': discount_type_inv,
