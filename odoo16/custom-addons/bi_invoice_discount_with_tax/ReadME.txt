...
16.0.0.2 ==> Added discount and discount method in report and also fixed in some case show wrong amount of amount due in invoice.

16.0.0.3 ==> Update code for when chnages in discount amount at that time journal entry also update based on discount amount.

16.0.0.4 ==> Fixed issue of when select discount based on untaxed amount at that show wrong calculation in total and also update tax calculation for untaxed discount option.

16.0.0.5 ==> Fixed issue of when we have multiple account move at that time trace back occur.